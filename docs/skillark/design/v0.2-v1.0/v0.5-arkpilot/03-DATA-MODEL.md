...
| 实体 | 类型 | 通用约束 | 备注 |
|---|---|---|---|
| ai_profiles | 本版本新增 | 使用 TEXT UUID/ULID 主键；含 created_at/updated_at；核心状态使用独立列。 | 具体字段见迁移草案 |
| ai_analysis_runs | 本版本新增 | 使用 TEXT UUID/ULID 主键；含 created_at/updated_at；核心状态使用独立列。 | 具体字段见迁移草案 |
| install_plans | 本版本新增 | 使用 TEXT UUID/ULID 主键；含 created_at/updated_at；核心状态使用独立列。 | 具体字段见迁移草案 |
| install_plan_steps | 本版本新增 | 使用 TEXT UUID/ULID 主键；含 created_at/updated_at；核心状态使用独立列。 | 具体字段见迁移草案 |
| secret_references | 本版本新增 | 使用 TEXT UUID/ULID 主键；含 created_at/updated_at；核心状态使用独立列。 | 具体字段见迁移草案 |
| plan_validations | 本版本新增 | 使用 TEXT UUID/ULID 主键；含 created_at/updated_at；核心状态使用独立列。 | 具体字段见迁移草案 |
| model_usage_records | 本版本新增 | 使用 TEXT UUID/ULID 主键；含 created_at/updated_at；核心状态使用独立列。 | 具体字段见迁移草案 |
...
迁移草案：`design/sql/0005_v0_5_arkpilot.sql`
