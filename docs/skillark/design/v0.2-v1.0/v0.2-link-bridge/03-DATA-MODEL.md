...
| 实体 | 类型 | 通用约束 | 备注 |
|---|---|---|---|
| sources | 本版本新增 | 使用 TEXT UUID/ULID 主键；含 created_at/updated_at；核心状态使用独立列。 | 具体字段见迁移草案 |
| source_revisions | 本版本新增 | 使用 TEXT UUID/ULID 主键；含 created_at/updated_at；核心状态使用独立列。 | 具体字段见迁移草案 |
| repository_cache | 本版本新增 | 使用 TEXT UUID/ULID 主键；含 created_at/updated_at；核心状态使用独立列。 | 具体字段见迁移草案 |
| update_checks | 本版本新增 | 使用 TEXT UUID/ULID 主键；含 created_at/updated_at；核心状态使用独立列。 | 具体字段见迁移草案 |
| skill_version_files | 本版本新增 | 使用 TEXT UUID/ULID 主键；含 created_at/updated_at；核心状态使用独立列。 | 具体字段见迁移草案 |
...
迁移草案：`design/sql/0002_v0_2_link_bridge.sql`
