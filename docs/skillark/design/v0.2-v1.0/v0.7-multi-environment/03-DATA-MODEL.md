...
| 实体 | 类型 | 通用约束 | 备注 |
|---|---|---|---|
| environments | 本版本新增 | 使用 TEXT UUID/ULID 主键；含 created_at/updated_at；核心状态使用独立列。 | 具体字段见迁移草案 |
| environment_capabilities | 本版本新增 | 使用 TEXT UUID/ULID 主键；含 created_at/updated_at；核心状态使用独立列。 | 具体字段见迁移草案 |
| environment_paths | 本版本新增 | 使用 TEXT UUID/ULID 主键；含 created_at/updated_at；核心状态使用独立列。 | 具体字段见迁移草案 |
| environment_credentials | 本版本新增 | 使用 TEXT UUID/ULID 主键；含 created_at/updated_at；核心状态使用独立列。 | 具体字段见迁移草案 |
| cross_env_operations | 本版本新增 | 使用 TEXT UUID/ULID 主键；含 created_at/updated_at；核心状态使用独立列。 | 具体字段见迁移草案 |
| platform_test_results | 本版本新增 | 使用 TEXT UUID/ULID 主键；含 created_at/updated_at；核心状态使用独立列。 | 具体字段见迁移草案 |
...
迁移草案：`design/sql/0007_v0_7_multi_environment.sql`
